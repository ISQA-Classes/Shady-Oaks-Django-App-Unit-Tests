...
class Tee_Test_adduser(unittest.TestCase):
    ...
    def test_add_user(self):
        ...
        button.click()
        time.sleep(5)
        # Begin add event part of test
        driver.get('http://shadyoaksgolfcourse.pythonanywhere.com/admin/main/event/add/')
        vtext_field = driver.find_element_by_id("id_event_name")
        vtext_field.send_keys("EventTest")
        ...
        #Delete
        driver.find_element_by_link_text("EventTest").click()
        time.sleep(5)
