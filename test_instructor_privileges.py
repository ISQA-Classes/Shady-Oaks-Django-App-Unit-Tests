...
class ShadyOaksTestUserPrivileges(unittest.TestCase):
    ...
    def test_instructor(self):
        ...
        time.sleep(5)
        instructor = driver.find_element_by_css_selector("#id_groups_from > option:nth-child(1)").click()
        select = driver.find_element_by_css_selector("#id_groups_add_link").click()
        elem = driver.find_element_by_css_selector("#user_form > div > div > input.default").click()
